...
另外，由于 `babel@6.x` 对 IE8 的支持不佳，你可能会遇到类似 [#28](https://github.com/ant-tool/atool-build/issues/28) 和 [#858](https://github.com/ungtb10d/ant-design/issues/858) 的 default 报错的问题。
...
目前社区也有很多基于 antd 定制的 [脚手架](https://github.com/ungtb10d/ant-design/issues/129)，欢迎进行试用和贡献。
