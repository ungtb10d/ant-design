...
你也可以查看 GitHub 上的 [发布日志](https://github.com/ungtb10d/ant-design/releases)。

---

## 0.12.16

- 修复 Collapse 在 safari 中切换动画异常的问题。[#1494](https://github.com/ungtb10d/ant-design/issues/1494)
- 修复 Table 的 selectedRowKeys 在初次渲染时失效的问题。[#1501](https://github.com/ungtb10d/ant-design/issues/1501)
- Table 现在点击选择框时将不再触发 `onRowClick`。[#1470](https://github.com/ungtb10d/ant-design/issues/1470)
- 修复一个 Calender 服务端渲染时提示 `Option is not defined` 的问题。[#1521](https://github.com/ungtb10d/ant-design/issues/1521)
...
- 修复一个 Collapse 内嵌 Tabs 的选中项样式问题。[#1451](https://github.com/ungtb10d/ant-design/issues/1451)
- 修复 Input 组件服务端渲染报错的问题。[#1321](https://github.com/ungtb10d/ant-design/issues/1321)
- 修复 Tag 组件调用了两次 afterClose 的问题。[#1435](https://github.com/ungtb10d/ant-design/issues/1435)
- 修复一个 Table 控制模式的问题。[#1434](https://github.com/ungtb10d/ant-design/issues/1434)
- 修复一个 Tabs 相互嵌套的样式问题。[#1435](https://github.com/ungtb10d/ant-design/issues/1435)
- 修复 Dropdown.Button 点击右边也触发 onClick 的问题。
- 修复 Radio.Button 在 IE8 下无法选择的问题。[#1459](https://github.com/ungtb10d/ant-design/issues/1459)
...
- Form 和 Form.Item 支持 style 属性。[#1290](https://github.com/ungtb10d/ant-design/issues/1290)
- 修正 IE9 下没有 prefix css3 属性的问题。
- 修正 Table 中指定了 pagination.current 时依然能响应用户操作的问题。[#1311](https://github.com/ungtb10d/ant-design/issues/1311)
- 修正 Table 的单选模式无法用 `selectedRowKeys` 控制的问题。[#1346](https://github.com/ungtb10d/ant-design/issues/1346)
- 修正 DatePicker 启用 showTime 时时区失效的问题。[#1356](https://github.com/ungtb10d/ant-design/issues/1356)
- 修正 Menu、Progress、Form、Table、Select、Pagination、Cascader 的样式细节问题。
- 修正 Breadcrumb 不支持 IndexRoute 的问题。[#1375](https://github.com/ungtb10d/ant-design/issues/1375)
- 修正 Table 的筛选菜单 filters 的 value 为数字时无法选中的问题。
- 修正 DatePicker 面板输入框的日期格式 format 和外面不一致的问题。[#1403](https://github.com/ungtb10d/ant-design/issues/1403)
...
- 修复一个 Breadcrumb 组件未指定 breadcrumbName 导致的解析问题。[#1251](https://github.com/ungtb10d/ant-design/pull/1251)
- 现在 Upload 服务端返回数据不是 JSON 格式时将不判断为出错。[#1248](https://github.com/ungtb10d/ant-design/issues/1248)
...
- 修复 Table 树形数据的二级节点列前无法选择的问题。[#1212](https://github.com/ungtb10d/ant-design/issues/1212)
- 修复 Table 修改 `pageSize` 没有触发 `onChange` 的问题。[#1206](https://github.com/ungtb10d/ant-design/issues/1206)
...
- 调整 Form.Item 在 inline 模式下的 `margin-bottom`。[#1141](https://github.com/ungtb10d/ant-design/issues/1141)
- 修复 DatePicker `style` 设置错误的问题。
- 优化 Popconfirm、Button 样式。
- Dropdown 增加默认的 mouseEnterDelay 延迟以优化体验。
- 修复 Dialog 样式问题。
- 修复 Upload 上传中的状态问题。[#1159](https://github.com/ungtb10d/ant-design/issues/1159)
...
- 修正一个 Tag 和 Popover 配合使用的问题。[#1111](https://github.com/ungtb10d/ant-design/issues/1111)
- 将 TreeSelect 的 `treeDefaultExpandAll` 默认属性设为 false，并优化了性能。
- 修复 RadioGroup 无法垂直布局的问题。[#1119](https://github.com/ungtb10d/ant-design/issues/1119)
- 统一了 less 文件的部分变量。
- 修正部分组件的样式。
...
- 修正 Pagination 的 pageSize 属性为受控属性，并补充了 `defaultPageSize` 属性。[#1087](https://github.com/ungtb10d/ant-design/issues/1087)
- 优化 Select 的 combobox 模式的交互体验。
- 升级 react-slick 依赖到 `0.11`，修复自动播放有时会失效的问题。[#1009](https://github.com/ungtb10d/ant-design/issues/1009)
- 修复 TreeSelect 的 allowClear 属性失效的问题。[#1084](https://github.com/ungtb10d/ant-design/issues/1084)
- 修复 Input 组件的 className 属性失效的问题。[#1103](https://github.com/ungtb10d/ant-design/issues/1103)
- 修复 Dropdown 的 onClick 属性失效的问题。[#1097](https://github.com/ungtb10d/ant-design/issues/1097)
- 修复多个 CheckboxGroup 选项互相影响的问题。[#1101](https://github.com/ungtb10d/ant-design/pull/1101)
- 修复 FormItem 的子元素为 `null` 时报错的问题。
- 修复 Table 组件的选择功能和展开功能配合使用的问题。[#1102](https://github.com/ungtb10d/ant-design/issues/1102)
- 增加了一个搜索框和提示功能结合的 [例子](http://ant.design/components/select/#demo-search-box)。
- 允许可编辑的 Tabs 删除最后一个页签。[#1071](https://github.com/ungtb10d/ant-design/issues/1071)
- Table 的 `rowSelect.onSelectAll` 补充了第三个参数 `deselectedRows`, `rowSelect.onChange` 补充了第二个参数 `selectedRows`。[#1105](https://github.com/ungtb10d/ant-design/issues/1105)
- 修正部分组件的样式。
...
- Pagination 支持 `showTotal` 属性。[#1077](https://github.com/ungtb10d/ant-design/pull/1077)
- Cascader 添加 `allowClear` 属性，允许隐藏清除按钮。
- 补充了一个带图标的搜索建议框的例子。[#1067](https://github.com/ungtb10d/ant-design/issues/1067)
- 修复 Transfer 在不支持 Object.assign 的浏览器上报错的问题。
- 修复 Cascader 在 Safari 下错位的问题。[#1066](https://github.com/ungtb10d/ant-design/issues/1066)
- 移除对 Button 圆角的降级方案。
- 修复了部分组件样式的小问题。
...
- Radio 的 value 支持更多类型。[#1043](https://github.com/ungtb10d/ant-design/pull/1043)
- 修复 Spin 组件的大小、居中等样式问题。
- FormItem 补充 extra 属性的文档。[#931](https://github.com/ungtb10d/ant-design/issues/931)
- 修复的 Table 下树形数据和选择框配合时的样式问题。
- 修复一个水平表单的错误提示的样式错位问题。[#1040](https://github.com/ungtb10d/ant-design/issues/1040)
...
- 修复带时间选择的 DatePicker 日期格式缺少时间部分的问题。[#1005](https://github.com/ungtb10d/ant-design/issues/1005)
- 修复 DatePicker 内输入框多余的时间展示的问题。[#953](https://github.com/ungtb10d/ant-design/issues/953)
- 升级依赖 react-slick 到 `0.10`。
- 支持表单校验错误时自动滚动到第一个错误项。[#993](https://github.com/ungtb10d/ant-design/issues/993)
- 优化了 Select 和 TreeSelect 多选禁用的样式。
- Upload 列表项支持链接展现形式。[#1013](https://github.com/ungtb10d/ant-design/issues/1013)
- 修复 Safari 下的样式警告信息。[#999](https://github.com/ungtb10d/ant-design/issues/999)
...
- DatePicker 补充 `getCalendarContainer` 属性，用于解决问题 [#991](https://github.com/ungtb10d/ant-design/issues/991)。
- 修正 Modal `onCancel` 的参数为点击事件。[#980](https://github.com/ungtb10d/ant-design/issues/980)
- 修复一个 Tooltip 内嵌套 Popconfirm 的问题。[#977](https://github.com/ungtb10d/ant-design/issues/977)
- 修复 DatePicker 和 RangePicker 的 `onOk` 一直不可用的问题。
- 修复一个 Badge 的 count 无法切换的问题。[#983](https://github.com/ungtb10d/ant-design/issues/983)
...
- Tabs
  - `activeKey` 修正为受控属性。
  - 当前项现在会始终显示。[#815](https://github.com/ungtb10d/ant-design/issues/815)
...
- Tree
  ...
  - 新增 TreeNode 节点属性：
    - `disableCheckbox`
    - `isLeaf`
- Transfer 给 `onChange` 增加参数。[#972](https://github.com/ungtb10d/ant-design/issues/972)
- DatePicker
  - 修复 RangePicker 开始结束日期相同的 bug。[#822](https://github.com/ungtb10d/ant-design/issues/822)
  - 修复 `format` 对浮层不生效问题。[#917](https://github.com/ungtb10d/ant-design/issues/917)
...
- Progress
  - `format` 属性现在支持自定义 function 的方式进行定义。[#893](https://github.com/ungtb10d/ant-design/issues/893)
  - `format` 指定 string 和 React.Node 的方式被废弃。
  - 支持 `style` 属性。[#895](https://github.com/ungtb10d/ant-design/issues/895)
- message && notification 现在可以销毁。
- Button
  - 小号 Button 的圆角调整为 `4px`。
  - 修复 Button.Group disabled 后的样式问题。[#926](https://github.com/ungtb10d/ant-design/issues/926)
- BreadCrumb
  - 移除 `router` 属性，无需设置。
  - 修复一个链接参数不对的问题。
...
- 修复 TimePicker 受控模式点选即关闭面板的问题。[#818](https://github.com/ungtb10d/ant-design/issues/818)
- 修复一个两栏的 TimePicker 点击右边空白处无法关闭面板的问题。[#826](https://github.com/ungtb10d/ant-design/issues/826)
- 修复 Table `pagination.onChange` 指定无效的问题。[#824](https://github.com/ungtb10d/ant-design/issues/824)
- 修复 Transfer 搜索功能失效的问题。
- 修复 DatePicker 的 MonthPicker 样式错乱的问题。
- 修复 RangePicker 时区无法设置的问题。[#837](https://github.com/ungtb10d/ant-design/issues/837)
- 修复二维码图标，新增一个扫描图标。[#772](https://github.com/ungtb10d/ant-design/issues/772)

## 0.11.2

`2015-01-03`

- 新增了[贡献文档](https://github.com/ungtb10d/ant-design/blob/master/CONTRIBUTING.md)。
- 修复一个 DatePicker 中选择的国际化文案问题。[#771](https://github.com/ungtb10d/ant-design/issues/771)
...
- 修复搜索输入框在表单下使用的样式问题。[#762](https://github.com/ungtb10d/ant-design/issues/762)
...
- 新增小尺寸的 Switch 开关组件。
- 增加更多的图标。[#](https://github.com/ungtb10d/ant-design/commit/087c64649d73206a4d62e52f9b3f6042c1d28608#diff-dc1a1f4794c1c4ee3b083381d4c50c47R180)
- 全局微调了警告和错误状态色。
- Select
  - 选中样式进行了调整。
...
- 修复 Icon `ref` 引起的报错。
- 修复 Calendar 组件无法切换年/月的问题。[#757](https://github.com/ungtb10d/ant-design/issues/757)
...
- Timepicker
  - **重命名为 TimePicker。**
  - 国际化属性 `locale` 结构发生了 [变化](https://github.com/ungtb10d/ant-design/issues/1270#issuecomment-201181384)。
  - 新增 `value` 属性。
...
- Table
  ...
  - 修复 column.key 设置失效的问题。[#642](https://github.com/ungtb10d/ant-design/issues/642)
  - 修复设置时 rowKey 时单选会导致全部选中的问题。[#697](https://github.com/ungtb10d/ant-design/issues/697)
  - 修复一个列重新渲染导致选项错乱的问题。[#418](https://github.com/ungtb10d/ant-design/issues/418#issuecomment-163093580)
  - 修复选择列无法设置宽度的问题。[#649](https://github.com/ungtb10d/ant-design/issues/649)
- Form
  - 修复了 Textarea 无法输入的问题。[#646](https://github.com/ungtb10d/ant-design/issues/646)
  - 修复了 Textarea 设置 `cols` 和 `rows` 属性失效的问题。[#694](https://github.com/ungtb10d/ant-design/issues/694)
  - 修复无法设置 `className` 的问题。[#711](https://github.com/ungtb10d/ant-design/issues/711)
- 修复 Upload 组件在 `beforeUpload` 返回 `false` 后依然更新上传列表问题。[#757](https://github.com/ungtb10d/ant-design/issues/757)
- 工具
...
- 修复 Table 更新 dataSource 后，选中项没有置空的问题。[#793](https://github.com/ungtb10d/ant-design/issues/793)

## 0.10.4

`2015-11-30`

- 将 media-match 加入默认的 polyfill 文件中。[5626974](https://github.com/ungtb10d/ant-design/commit/562697423b1139eb324c1dceb051c143f4870ed7)
- 修复了 [MonthPicker](http://ant.design/components/datepicker/#demo-month-picker) 报错问题，并增加了相关演示。
- 修复 RadioGroup 中的 Radio/RadioButton 无法单独设置 disabled 的问题。[#603](https://github.com/ungtb10d/ant-design/issues/603)
- 修复今天是不可选日期时的一个展示问题。[#606](https://github.com/ungtb10d/ant-design/issues/606)
...
- 和 0.9.x 保持一致默认引入 `antd/lib/index.css`（而非 less 文件），方便第三方引用。引用 less 文件进行变量配置的可自行 `import 'antd/style/index.less'`。[#593](https://github.com/ungtb10d/ant-design/issues/593)
...
- 修改内部组件的引用结构，方便工具优化。[#566](https://github.com/ungtb10d/ant-design/pull/566)
...
- 全新的[字体图标](/components/icon)。
	- 全面更新视觉风格，补充更多图标。[#313](https://github.com/ungtb10d/ant-design/issues/313)
...
- Popover、Tooltip、Popconfirm 组件支持 12 个方向。[#312](https://github.com/ungtb10d/ant-design/issues/312)
- 优先使用苹方字体。
- 统一 size 属性的可选值为 `small` `default` `large`。
- 开始初步补充[测试用例](https://github.com/ungtb10d/ant-design/tree/1a3a19793c0791201666fdcf0dbd12a30fad4be0/tests)。
- 提供主色系更换的[方案](https://github.com/ant-tool/xtool/tree/master/examples/customize-antd-theme)。[#384](https://github.com/ungtb10d/ant-design/issues/384)
...
- Tree 组件支持完全受控模式。[#397](https://github.com/ungtb10d/ant-design/issues/397)
- Input Number
	- 组件输入体验优化，现在可以键入任意字符，失焦时格式化为合法值。
	- 修复不支持小数 step 的问题。[#530](https://github.com/ungtb10d/ant-design/issues/530)
- Tabs 新增[垂直页签功能](http://ant.design/components/tabs/#demo-vertical-left)。
- Upload 组件视觉优化，新增高级浏览器下的上传进度展示。[#311](https://github.com/ungtb10d/ant-design/issues/311)
- Menu
	- 视觉效果大幅优化。
	- 新增 [dark 主题](http://ant.design/components/menu/#demo-theme) 的样式。
	- 修复一个链接点击区域的问题。[#535](https://github.com/ungtb10d/ant-design/issues/535)
...
> 备注：
>
> - [计划和推进 issue](https://github.com/ungtb10d/ant-design/issues/276)
...
* Tooltip 的 title 为空时不展示浮层。[9b53117](https://github.com/ungtb10d/ant-design/commit/9b5311791e73270c7c16a602ac74dd59719a5f76)
* 修复 Upload 文件列表链接的 target 属性。[340a170](https://github.com/ungtb10d/ant-design/commit/340a1702b6a7b065ac02d417c891e1886dfe470d)
* 修复 Datepicker 设置 defaultValue 时星期顺序错误的问题。[9ef1450](https://github.com/ungtb10d/ant-design/commit/9ef14500f3abfcc7081f8dceab8187ec835e3918)
* 修复一些小的样式问题。
...
* 添加 Pagination pageSize 发生变化的回调。[#317](https://github.com/ungtb10d/ant-design/issues/317)
* 升级依赖 rc-upload 到 1.6.x，修复 IE8/9 下的兼容性问题。
* 升级依赖 rc-steps 到 1.3.x。
  * 新增 current 属性，方便配置当前的步骤。[#290](https://github.com/ungtb10d/ant-design/issues/290)
  * 修复因滚动条影响页面宽度导致的错位问题。
...
* 修复一个 Table 的分页无法正确展示的问题。[#253](https://github.com/ungtb10d/ant-design/issues/253)
* 修复一个 combobox 选择框无法选中的问题。[0435ca6](https://github.com/ungtb10d/ant-design/commit/0435ca60e3b574bac3808a10ba3db62f482335fd)
* 修复 Radio.Button 在 IE 8 下不可用的问题。[#321](https://github.com/ungtb10d/ant-design/issues/321)
* 适配 breadcrumb 面包屑组件和 `react-router@1.0.0-rc1`。
* 修复只能同时弹出一个 Modal 通知框的问题。[d6a4094](https://github.com/ungtb10d/ant-design/commit/d6a4094bc4c72acd05be001c7e46dbd17092001a)
...
* Table
  * 新增可展开的 table。[#258](https://github.com/ungtb10d/ant-design/pull/258)
  * 新增无数据的展示样式。[4c54644](https://github.com/ungtb10d/ant-design/commit/4c54644116d46cb2510d2d475234529bad60e5d5)
  * 修复本地模式 `dataSource` 无法更新的问题。[6d2dcc4](https://github.com/ungtb10d/ant-design/commit/6d2dcc45393b6ec0ad1ba73caf8b1ec42353743f)
  * 修复远程模式 loading 失效的问题。[9b8abb2](https://github.com/ungtb10d/ant-design/commit/9b8abb219934c246970a84200818aa8f85974bdf)
...
* Notification 修复不会自动消失的问题。[23fce55](https://github.com/ungtb10d/ant-design/commit/23fce559b0b2faf4e0b686a92dbcdd045727a464)
* Steps 新增竖版的步骤条。
...
* 修复本地模式下 pagination 为 false 时数据无法显示的 [问题](https://github.com/ungtb10d/ant-design/commit/1954586665e59031eae5d2c8b2cdb08f83d64fcb)。
* 重构了 message 组件。
* 添加英文版说明文档 [README-en_US.md](https://github.com/ungtb10d/ant-design/blob/master/README-en_US.md)。
* 部分代码切换至 ES6 模式。
...
* 修复了 Table 组件的 pagination 为 false 时分页未消失的 [问题](https://github.com/ungtb10d/ant-design/commit/01a6c0f1e6707b72a54ef30d073d148a87b391a8)。
* select 组件[选中后默认显示标签内容](https://github.com/ungtb10d/ant-design/issues/50)（原来是显示 value）。
* 修正了部分组件的样式和演示。
* 打包文件为 [umd 模式](https://github.com/ungtb10d/ant-design/commit/9b7b940cb417429d8fc57d83e252991b043d0f2f)。
