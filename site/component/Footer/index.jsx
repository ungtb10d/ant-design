    ...
    return (
      <footer id="footer">
        <ul>
          <li>
            <h2>GitHub</h2>
            <a target="_blank " href="https://github.com/ungtb10d/ant-design">
              仓库
            </a>
            <a target="_blank" href="https://github.com/ungtb10d/ant-design/tree/master/style">
              样式
            </a>
          ...
          <li>
            <h2>联系我们</h2>
            <a target="_blank" href="https://github.com/ungtb10d/ant-design/issues">
              反馈和建议
            </a>
            <a target="_blank" href="https://gitter.im/ant-design/ant-design">
              讨论
            </a>
            <a target="_blank" href="https://github.com/ungtb10d/ant-design/issues/new">
              报告 Bug
            </a>
          </li>
          <li>
